 ...
 *
 * Takes solved sudoku grid, removes random entries based on level of difficulty,
 * and returns a playable sudoku grid. Level of difficulty is as follows:
 *
 * Easy: 45 given entries on grid with a minimum of 4 entries in each row, column,
 * and 3x3 square.
 *
 * Medium: 35 given entries on a grid with a minimum of 3 entries in each row,
 * column, and 3x3 square.
 *
 * Hard: 30 given entries on a grid with a minimum of 2 entries in each row, column,
 * and 3x3 square.
 *
 * Evil: 25 given entries on a grid with a minimum of 0 entries in each row, column,
 * and 3x3 square.
 */
